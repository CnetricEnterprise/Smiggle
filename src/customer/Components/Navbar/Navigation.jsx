...
import logo from "../../../logos/smiggle.svg";
...
export default function Navigation() {
  ...
  useEffect(() => {
    if (localStorage.getItem("accessToken")) {
      getCustomerInfo()
        .then((res) => {
          let firstName = res?.data?.customer?.firstName;
          if (firstName) {
        ...
        <nav aria-label="Top" className="mx-auto">
          ...
          >
            <div className="flex h-16 items-center px-11">
              ...
              {/* Logo */}
              <div
                className="ml-4 flex justify-center lg:ml-0 "
                // style={{
                //   display: "flex",
              ...
              >
                <Link to="/">
                  ...
                  <img
                    ...
                    src={logo}
                    // src="https://www.whitefriars.co.uk/wp-content/uploads/2017/09/smiggle.png"
                    alt="Shopwithzosh"
                    className="h-10  mr-2 "
                    style={{
                      borderRadius: 25,
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {newUser?.newUser?.data?.customerAccessTokenCreate
                    ...
                    <div>
                      ...
                      >
                        ...
                        {localStorage.getItem("accessToken") && info}
                      </Avatar>
                      {/* <Button
                        id="basic-button"
                        aria-controls={open ? "basic-menu" : undefined}
                    ...
                    <Button
                      onClick={handleOpen}
                      className="text-sm font-medium text-gray-900 hover:text-gray-900 rounded border border-gray-900 hover:border-transparent hover:bg-gray-100 transition duration-300"
                      style={{ color: "black" }}
                    >
                      Signin
                    </Button>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    ...
                    />
                    <span
                      className="ml-2 text-sm font-medium text-white group-hover:text-gray-800"
                      style={{ color: "black" }}
                    >
                      {newUser?.newUser?.data?.customerAccessTokenCreate
                        ?.customerAccessToken.accessToken
                        ? cartItems?.cartItems?.data?.cart?.lines?.edges.length
                        : 0}
                    </span>
